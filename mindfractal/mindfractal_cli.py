...
def main():
    ...
    viz_parser.add_argument('--mode', choices=['orbit', 'basin', 'lyapunov'],
                           default='orbit', help='Visualization mode')
    ...
    frac_parser.add_argument('--c1-range', nargs=2, type=float, default=[-1.0, 1.0],
                            help='c1 parameter range')
    frac_parser.add_argument('--c2-range', nargs=2, type=float, default=[-1.0, 1.0],
                            help='c2 parameter range')
    frac_parser.add_argument('--max-steps', type=int, default=500, help='Max simulation steps')
    frac_parser.add_argument('--criterion', choices=['divergence_time', 'final_norm', 'lyapunov', 'attractor_type'],
                            default='divergence_time', help='Fractal map criterion')
    ...
    ana_parser.add_argument('--mode', choices=['fixed_points', 'lyapunov', 'attractor'],
